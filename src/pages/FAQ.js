    ...
    <Container id="responsive-cards" className="my-0 mx-auto py-0 px-1">
      <Card>
        <Card.Body>
          ...
          <Card.Text>
            Irvine Hacks gathers high school students together for 24 hours to collaborate and “hack”! Participants design, execute, and present a project based around a theme, winning cool prizes and having fun in the process!
          </Card.Text>
        </Card.Body>
      </Card>
      <Card>
      ...
      <Card>
        <Card.Body>
          ...
          <Card.Text>
            Absolutely no programming experience is necessary! Workshops will be open throughout the day to teach basic coding skills, though!
          </Card.Text>
        </Card.Body>
      </Card>
      <Card>
        <Card.Body>
          ...
          <Card.Text>
            Check out our sponsorship prospectus, and contact us at <a href="mailto:sponsors@irvinehacks.com">sponsors@irvinehacks.com</a>.
          </Card.Text>
        </Card.Body>
      </Card>
    </Container>
